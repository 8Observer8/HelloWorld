...
<html>
    ...
    <body>
        ...
        <p>Если Вы уверенно знаете английский и Qt, то можно найти удалённую работу за рубежом (или фрилансить). Официально оформиться в России, как ИП (индивидуальный предприниматель).</p>
</body>
</html>
