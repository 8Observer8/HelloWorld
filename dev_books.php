...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Список книг по разработке ПО</title>
    </head>
    <body>
        <?php
        ...
        ?>
        <h1>Список книг по разработке ПО</h1>
        <h3>Первые две книги одинаково хорошо подойдут разработчикам на C++, Java и C#. Хотя в первой книге примеры на Java, а во второй - на C#. Я все эти книги использую для разработки ПО на фреймворке Qt (на языке C++)</h3>
       <div id="list">
            <h3>Чистый код. Создание, анализ и рефакторинг</h3>
            <div>
                <strong>Название:</strong> Чистый код. Создание, анализ и рефакторинг<br />
                <strong>Год:</strong> 2010<br />
                <strong>Автор:</strong> Мартин Р.<br />
                <strong>Количество страниц:</strong> 464<br />
                <strong>Язык:</strong> русский<br />
                <strong>Скачать:</strong> <a href="http://rutracker.org/forum/viewtopic.php?t=3088098">http://rutracker.org/forum/viewtopic.php?t=3088098</a><br />
            ...
            <h3>Принципы, паттерны и методики гибкой разработки на языке C#</h3>
            <div>
                <strong>Название:</strong> Принципы, паттерны и методики гибкой разработки на языке C#<br />
                <strong>Год:</strong> 2011<br />
                <strong>Автор:</strong> Martin R., Martin M. / Мартин Р.С., Мартин М.<br />
                <strong>Количество страниц:</strong> 757<br />
                <strong>Язык:</strong> русский<br />
                <strong>Скачать:</strong> <a href="http://rutracker.org/forum/viewtopic.php?t=4295746">http://rutracker.org/forum/viewtopic.php?t=4295746</a><br />
                <strong>Исходники:</strong> <a href="http://www.objectmentor.com/PPP/">http://www.objectmentor.com/PPP/</a><br />
            ...
            <h3>Эффективное использование C++. 55 верных советов улучшить структуру и код ваших программ</h3>
            <div>                
                <strong>Название:</strong> Эффективное использование C++. 55 верных советов улучшить структуру и код ваших программ<br />
                <strong>Год:</strong> 2006<br />
                <strong>Автор:</strong> Скотт Мэйерс<br />
                <strong>Количество страниц:</strong> 301<br />
                <strong>Язык:</strong> русский<br />
                <strong>Скачать:</strong> <a href="http://rutracker.org/forum/viewtopic.php?t=3658180">http://rutracker.org/forum/viewtopic.php?t=3658180</a><br />
            ...
            <h3>Эффективное использование STL</h3>
            <div>                
                <strong>Название:</strong> Эффективное использование STL<br />
                <strong>Год:</strong> 2002<br />
                <strong>Автор:</strong> Скотт Мэйерс<br />
                <strong>Количество страниц:</strong> 226<br />
                <strong>Язык:</strong> русский<br />
                <strong>Скачать:</strong> <a href="http://rutracker.org/forum/viewtopic.php?t=956876">http://rutracker.org/forum/viewtopic.php?t=956876</a><br />

                <p><strong>Описание:</strong><br />
                    Библиотека STL (Standard Template Library) произвела настоящий переворот в программировании C++, но ее освоение традиционно считалось весьма сложной задачей. К счастью, ситуация изменилась. В этой книге известный автор и программист Скотт Мейерс раскрывает секреты мастерства, позволяющие добиться максимальной эффективности при работе с этой библиотекой. В книге приводится множество рекомендаций и приемов работы в STL. Эти рекомендации подкреплены подробным анализом и убедительными примерами, поэтому читатель легко узнает, как решить ту или иную задачу и принять верное решение.</p>
            </div>

            <h3>Professional C++</h3>
            <div>                
                <strong>Название:</strong> Professional C++<br />
                <strong>Год:</strong> 2011<br />
                <strong>Автор:</strong> Marc Gregoire, Nicholas A. Solter, Scott J. Kleper<br />
                <strong>Количество страниц:</strong> 1104<br />
                <strong>Язык:</strong> английский<br />
                <strong>Скачать:</strong> <a href="http://kickass.to/wrox-professional-c-plus-plus-2nd-edition-2011-retail-ebook-debt-t7461950.html">http://kickass.to/wrox-professional-c-plus-plus-2nd-edition-2011-retail-ebook-debt-t7461950.html</a><br />
                <strong>Исходники:</strong> <a href="http://www.wrox.com/WileyCDA/WroxTitle/Professional-C-2nd-Edition.productCd-0470932449,descCd-DOWNLOAD.html">http://www.wrox.com/WileyCDA/WroxTitle/Professional-C-2nd-Edition.productCd-0470932449,descCd-DOWNLOAD.html</a><br />
