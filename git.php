...
<html>
    ...
    <body>
        ...
        <ul>
            ...
            <li>сохраняем файлы проекта на удалённый репозитарий, для этого вводим комманды:</li>
            <ul>
            ...
            <li>Допустим в новой ветке мы удаляем несколько файлов, несколько добавляем, а несколько изменяем. И хотим сохранить все изменения на удалённый репозитарий.</li>
