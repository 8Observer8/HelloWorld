...
<html>
    ...
    <body>
        ...
        <div id="list">
            ...
            <h3>Приемы объектно-ориентированного проектирования. Паттерны проектирования</h3>
            <div>
                <strong>Название:</strong> Приемы объектно-ориентированного проектирования. Паттерны проектирования<br />
                <strong>Год:</strong> 2010<br />
                <strong>Автор:</strong> Гамма Э., Хелм Р., Джонсон Р., Влиссидес Дж.<br />
                <strong>Количество страниц:</strong> 366<br />
                <strong>Язык:</strong> Русский<br />
                <strong>Скачать:</strong> <a href="http://rutracker.org/forum/viewtopic.php?t=3193196">http://rutracker.org/forum/viewtopic.php?t=3193196</a><br />

                <p><strong>Описание:</strong><br />
                    В предлагаемой книге описываются простые и изящные решения типичных задач, возникающих в объектно-ориентированном проектировании. Паттерны появились потому, что многие разработчики искали пути повышения гибкости и степени повторного использования своих программ. Найденные решения воплощены в краткой и легко применимой на практике форме. Авторы излагают принципы использования паттернов проектирования и приводят их каталог. Таким образом, книга одновременно решает две задачи. Во-первых, здесь демонстрируется роль паттернов в создании архитектуры сложных систем. Во-вторых, применяя содержащиеся в справочнике паттерны, проектировщик сможет с легкостью разрабатывать собственные приложения.</p>
                <p>Издание предназначено как для профессиональных разработчиков, так и для программистов, осваивающих объектно-ориентированное проектирование.</p>
            </div>
