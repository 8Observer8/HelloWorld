...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Создание юнит-тестов на Qt C++ (TDD)</title>
    </head>
    <body>
        <?php
...
<p>По условию задачи, нужно написать функцию, которая возращает: -1 - если первый аргумент меньше второе, 1 - если первый аргумент больше второе и 0 - если оба аргумента равны друг другу</p>
...
<li>в окне "Application Output" мы можем видеть, что удачно завершился только первый тест, так как фукнция compare() всегда возвращает ноль. Мы передали два нуля и ожидали ноль в первом тесте.
